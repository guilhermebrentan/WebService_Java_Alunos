				...
				case "2": 
					{
						...
						try //verifica se ainda tem coisas na fila
						{
							for(int i = 1;;i++)//loop infinito
							{
								...
								{
									System.out.println("-----------------------------------------------------------");
									System.out.println(i+"º resultado cadastrado: ");
									System.out.println(ClienteWS.getObjeto(String.class, "http://localhost:3000/executar", String.valueOf(aux.getRa()), String.valueOf(aux.gerCod()), String.valueOf(aux.getNota()), String.valueOf(aux.getFreq())));
									System.out.println("-----------------------------------------------------------");
								}
								catch(Exception ex)
								{
